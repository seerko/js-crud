...
router.post("/product-create", function (req, res) {
  ...
  res.render("alert", {
    ...
    info: result ? "Продукт успішно створений" : "Продукт не створений",
  });
});
...
router.post("/product-edit", function (req, res) {
  ...
  res.render("alert", {
    style: "alert",
    title: result ? "Успішне виконання дії" : "Помилка",
    info: result ? "Продукт успішно оновлений" : "Продукт не знайдено",
  });
});
...
router.get("/product-delete", function (req, res) {
  ...
  res.render("alert", {
    style: "alert",
    title: result ? "Успішне виконання дії" : "Помилка",
    info: result ? "Продукт успішно видалений" : "Продукт не знайдено",
  });
});
